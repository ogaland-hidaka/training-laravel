...
class WebAPI {
    ...
    /**
     * ogaAuthにリクエストをPostする
     * @param {*} apiUrl
     * @param {*} param
     */
    async PostOgaAuthAPI(apiUrl, param) {
        let ogaauth_url = process.env.MIX_BASE_URL_OGA_AUTH
        let api_url = ogaauth_url + apiUrl;
        const res = await $axios.post(api_url, param);
        return res;
    }
}
